...
$$
   ...
   let LOCALVAR0;
   let LOCALVAR1 = LOCALVAR0 /* ** MSC-WARNING - MSCEWI1053 - OBJECT localVar0 MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */ + 45 / 13;
   let LOCALVAR2;
   let LOCALVAR3 = `local variable 3`;
   let LOCALVAR4 = `local variable 4`;
   let LOCALVAR5 = `local variable 5`;
   let LOCALVAR6 = `local variable 6`;
   let LOCALVAR7 = LOCALVAR6 /* ** MSC-WARNING - MSCEWI1053 - OBJECT localVar6 MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */;
   ...
   const MY_CONST_VAR5 = MY_CONST_VAR4 /* ** MSC-WARNING - MSCEWI1053 - OBJECT MY_CONST_VAR4 MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */;
   const MY_CONST_VAR5 = `${concatValue(VAL1 /* ** MSC-WARNING - MSCEWI1053 - OBJECT val1 MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */)}${concatValue(COL1 /* ** MSC-WARNING - MSCEWI1053 - OBJECT col1 MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */)}`;
   const MY_CONST_VAR6 = `;`;
   LOCALVAR1 = 123;
   LOCALVAR1 = LOCALVAR1 /* ** MSC-WARNING - MSCEWI1053 - OBJECT localVar1 MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */ + 45 / 13;
   ...
   // ** MSC-WARNING - MSCEWI1038 - THIS STATEMENT MAY BE A DYNAMIC SQL THAT COULD NOT BE RECOGNIZED AND CONVERTED **
   LOCALVAR8 = `${concatValue((EXEC(`SELECT  LTRIM(RTRIM(TO_CHAR(?, '000')))`,[LOCALVAR8 /* ** MSC-WARNING - MSCEWI1053 - OBJECT localVar8 MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */]))[0])}${concatValue((EXEC(`SELECT CAST( 41.522 AS CHAR(10))`))[0])}.csv`;
   if (JOBID /* ** MSC-WARNING - MSCEWI1053 - OBJECT jobid MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */ == `PU_CLERK`) {
      SAL_RAISE = 0.09;
   } else if (`${concatValue(VAL1 /* ** MSC-WARNING - MSCEWI1053 - OBJECT val1 MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */)}${concatValue(COL1 /* ** MSC-WARNING - MSCEWI1053 - OBJECT col1 MAY NOT WORK PROPERLY, ITS DATATYPE WAS NOT RECOGNIZED ** */)}` == `col1`) {
      SAL_RAISE = 0.08;
...
$$
   ...
   EXEC(`UPDATE table1 SET column1 = ?`,[WAGES]);
...
$$
   ...
   STRING_VALUE = (EXEC(`SELECT /*** MSC-ERROR - MSCEWI3013 - NLS PARAMETER 'NLS_DATE_LANGUAGE = language' NOT SUPPORTED ***/
 TO_CHAR(/*** MSC-WARNING - MSCEWI1020 - CUSTOM UDF 'JSDATE_UDF' INSERTED. ***/
PUBLIC.JSDATE_UDF(?), 'dd-mm-yyyy')`,[DATEPARAM]))[0];
   STRING_VALUE = (EXEC(`SELECT /*** MSC-ERROR - MSCEWI3013 - NLS PARAMETER 'NLS_DATE_LANGUAGE = language' NOT SUPPORTED ***/
 TO_CHAR(? :: TIMESTAMP, 'dd-mm-yyyy HH')`,[TIMESTAMPPARAM]))[0];
   NUM_VALUE = (EXEC(`SELECT TRUNC_UDF(?) /*** MSC-WARNING - MSCEWI1020 - CUSTOM UDF 'TRUNC_UDF' INSERTED. ***/`,[NUM_VALUE]))[0];
   NUM_VALUE = (EXEC(`SELECT TRUNC_UDF(?, 3) /*** MSC-WARNING - MSCEWI1020 - CUSTOM UDF 'TRUNC_UDF' INSERTED. ***/`,[NUM_VALUE]))[0];
   DATEPARAM = (EXEC(`SELECT TRUNC_UDF(/*** MSC-WARNING - MSCEWI1020 - CUSTOM UDF 'JSDATE_UDF' INSERTED. ***/
PUBLIC.JSDATE_UDF(?)) /*** MSC-WARNING - MSCEWI1020 - CUSTOM UDF 'TRUNC_UDF' INSERTED. ***/`,[DATEPARAM]))[0];
   DATEPARAM = (EXEC(`SELECT TRUNC_UDF(/*** MSC-WARNING - MSCEWI1020 - CUSTOM UDF 'JSDATE_UDF' INSERTED. ***/
PUBLIC.JSDATE_UDF(?), 'YEAR') /*** MSC-WARNING - MSCEWI1020 - CUSTOM UDF 'TRUNC_UDF' INSERTED. ***/`,[DATEPARAM]))[0];
   TIMESTAMPPARAM = (EXEC(`SELECT TRUNC_UDF(? :: TIMESTAMP) /*** MSC-WARNING - MSCEWI1020 - CUSTOM UDF 'TRUNC_UDF' INSERTED. ***/`,[TIMESTAMPPARAM]))[0];
